...
namespace IdleUpgrades.UpgradesBank
{
    internal class UpgradeLoader //TODO : Finish this class
    {
        ...
        private Dictionary<int, TypeUpgradeEnum> _upgradesType = new();
        private Dictionary<int, BaseNumber> _upgradesEffect = new();

        public List<BaseUpgrade> LoadNormalUpgrades()
        {
            List<BaseUpgrade> upgrades = new();

            for (int i = 0; i < _upgradesTitle.Count; i++)
            {
                var upgrade = new NormalUpgrade(_upgradesTitle[i], _upgradesDescription[i], _upgradesCost[i], _upgradesType[i], _upgradesEffect[i])
                    {
                        IsBought = _upgradesBought[i]
                    };
        ...
        private void InitializeUpgradeTest()
        {
            ...
            _upgradesType.Add(0, TypeUpgradeEnum.QiPerClick);
            _upgradesEffect.Add(0, new ClassicNumber(1));
            ...
            _upgradesType.Add(1, TypeUpgradeEnum.QiPerSecond);
            _upgradesEffect.Add(1, new ClassicNumber(0.1f));
            ...
            _upgradesType.Add(2, TypeUpgradeEnum.QiPerClick);
            _upgradesEffect.Add(2, new ClassicNumber(1));
            ...
            _upgradesType.Add(3, TypeUpgradeEnum.GoldPerClick);
            _upgradesEffect.Add(3, new ClassicNumber(0.1f));
            ...
            _upgradesType.Add(4, TypeUpgradeEnum.QiPerClick);
            _upgradesEffect.Add(4, new ClassicNumber(1));
            ...
            _upgradesType.Add(5, TypeUpgradeEnum.QiPerSecond);
            _upgradesEffect.Add(5, new ClassicNumber(0.1f));
            ...
            _upgradesType.Add(6, TypeUpgradeEnum.GoldPerSecond);
            _upgradesEffect.Add(6, new ClassicNumber(0.1f));
            ...
            _upgradesType.Add(7, TypeUpgradeEnum.GoldPerSecond);
            _upgradesEffect.Add(7, new ClassicNumber(0.1f));
            ...
            _upgradesType.Add(8, TypeUpgradeEnum.QiPerSecond);
            _upgradesEffect.Add(8, new ClassicNumber(0.1f));
            ...
            _upgradesType.Add(9, TypeUpgradeEnum.QiPerSecond);
            _upgradesEffect.Add(9, new ClassicNumber(0.1f));
        }
    }
}
